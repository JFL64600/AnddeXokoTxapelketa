# Cahier des charges - Amelioration de l'application de gestion de tournoi et de scores

## 1. Contexte et objectifs

L'application actuelle permet de gérer des tournois, les joueurs, les matchs et les scores. L'objectif est d'améliorer l'expérience utilisateur, la fiabilité des données, et les fonctionnalités de gestion (classements, historiques, exports).
